...
struct mat3 {
    mat3() :
	  e00(1.0f), e10(0.0f), e20(0.0f),
          e01(0.0f), e11(1.0f), e21(0.0f),
          e02(0.0f), e12(0.0f), e22(1.0f)
    {}

    mat3(float _e00, float _e10, float _e20,
          float _e01, float _e11, float _e21,
          float _e02, float _e12, float _e22
        ) :
...
struct mat4 {
    ...
    mat4(float _e00, float _e10, float _e20, float _e30,
          float _e01, float _e11, float _e21, float _e31,
          float _e02, float _e12, float _e22, float _e32,
          float _e03, float _e13, float _e23, float _e33
        ) :
